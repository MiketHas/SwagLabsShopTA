...
| :white_check_mark: | User can cancel order from cart                                    | - cancelOrderTest                          |
...
| :white_check_mark: | User can cancel order from the Checkout's page                     | - cancelOrderTest                          |
...
|                        | `CheckoutAddressTests`     | - continueWithPersonalInformationTest <br> - cancelOrderTest                                                                                                                                                                                                                                                                                                                                  |:white_check_mark:<br>:white_check_mark:
|                        | `CheckoutOverviewPageTests`     | - accessEachProductFromCheckoutTest <br> - taxCalculatedCorrectTest <br> - priceTotalCorrectTest  <br> - cancelOrderTest  <br> - finishOrderTest                                                                                                                                                                                                                                              |:white_check_mark:<br>:white_check_mark:<br>:white_check_mark:<br>:white_check_mark:<br>:white_check_mark:<br>
